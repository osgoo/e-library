                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input id="published_year"
                                    class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                    type="number" name="published_year" value="{{ $book->published_year }}" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="4"
                                    class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ $book->description }}</textarea>
                                @error('description')
                                    <ul class="text-sm text-red-600 space-y-1 mt-2">
                                        <li>{{ $message }}</li>
                                    </ul>
                            ...
                            <div class="md:col-span-2">
                                ...
                                @if($book->cover)
                                    <img src="{{ Storage::url($book->cover) }}" alt="" class="w-24 h-24 rounded object-cover mb-2">
                                @endif
